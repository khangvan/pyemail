...
parser.add_option("-p", "--password", dest="password", help="pass nhen", default="xxxx")
...
parser.add_option("-d", "--doc", dest="pdf", help="pdf doc attachment", default=False)
...
s.login(options.sender, options.password)
...
#python sendemail.py -f email@gmail.com -t email@gmail.com -s "Khang test khoảng trắng"  -i mylove.jpg -p mypdf.pdf
#python sendemail.py -f email@gmail.com  -p xxxx -t email@gmail.com -s "Khang test khoảng trắng"  -i mylove.jpg -d mydoc.pdf
